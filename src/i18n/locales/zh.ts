export default {
    ...
    "note.category.addChildText": "添加子分类",
    "note.category.cancel": "取消",
    "note.category.create.title": "添加分类",
    "note.category.create.placeholder": "请输入分类名称",
    "note.category.create.success": "分类创建成功",
    ...
    "ai.disabled.description": "请先在后台开启 AI 功能后再使用",
    "ai.tool.running": "执行中...",
    ...
    "ai.scroll_to_bottom": "滚动到底部",
    "ai.scroll_to_top": "滚动到顶部",
    "ai.stop": "停止",
};